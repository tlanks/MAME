...
#define RARCH_LOG(fmt, ...) \
   if (log_cb) log_cb(RETRO_LOG_INFO, "[mame]: " fmt, ## __VA_ARGS__)

#define RARCH_ERR(fmt, ...) \
   if (log_cb) log_cb(RETRO_LOG_ERROR, "[mame]: " fmt, ## __VA_ARGS__)

#define RARCH_WARN(fmt, ...) \
   if (log_cb) log_cb(RETRO_LOG_WARN, "[mame]: " fmt, ## __VA_ARGS__)

#define RARCH_DEBUG(fmt, ...) \
   if (log_cb) log_cb(RETRO_LOG_DEBUG, "[mame]: " fmt, ## __VA_ARGS__)
